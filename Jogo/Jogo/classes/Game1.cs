    ...
    {   
        ...
        protected override void Update(GameTime gameTime){
            ...
            if (ball.Position.X  == player1.Position.X + 24){
                // Inverte a direção da bola em x
                ball.Position.X *= -1.0f;
            }
            // Jogador 2 (paddle da direita)
        ...
        protected override void Draw(GameTime gameTime){
            ...
            spriteBatch.Begin();
            spriteBatch.DrawString(font, player1.score.ToString(), new Vector2(250, 30), Color.Red);
            spriteBatch.DrawString(font, player2.score.ToString(), new Vector2(510, 30), Color.Green);
